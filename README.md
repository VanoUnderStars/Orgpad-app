...
## Пример работы:
Примеры работы программы, а также скриншоты можно увидеть в файле [tutorial.pdf](tutorial.pdf). 
## Использование программы:
[APK файл](Orgpad.apk) доступен для скачивания в репозитории, проект доступен для сборки и редактирования на языке Kotlin в Android Studio.
